...
/*
    local
  add/udp_redirect/darwin/udp_redirect 0.0.0.0 161 10.0.0.23 5555 &
  add/udp_redirect/x64/udp_redirect 0.0.0.0 161 10.0.0.23 5555 &

    remote WB
  ./udp_redirect 0.0.0.0 5555 192.168.1.11 161 &
...
//#include <libc.h> // darwin
#include <arpa/inet.h> // arm wb
//#include <inet.h>
